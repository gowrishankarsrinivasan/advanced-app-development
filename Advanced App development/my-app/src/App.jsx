  ...
  return (
    <UserLayout>
      <Routes>
        ...
        <Route path="/courseform" element={<LazyLayout component={LazyCourseForm} />}/>
        <Route path="/payment" element={<LazyLayout component={lazyPaymentPage} />}/>        
      </Routes>
    </UserLayout>
  );
};
  ...
  return (
    <AdminLayout>
      <Routes>
        ...
        <Route path="/courseAddForm" element={<LazyLayout component={lazyAdminCourseForm}/>} />
        <Route path="/reply" element={<LazyLayout component={LazyQueryReply} />}/>
      </Routes>
    </AdminLayout>
  );
};
    ...
    <div className="App">
      <Suspense fallback={<LoadingSpinner />}>
        <Routes>
          ...
          <Route exact path="/bec.com/login" element={<LazyLayout component={LazyLogin} />}/>
          <Route exact path="/forgot-password" element={<LazyLayout component={lazyForgot} />}/>
